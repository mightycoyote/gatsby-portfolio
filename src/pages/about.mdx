...
In addition to plain-old HTML, CSS, and JavaScript, I have worked with: SCSS, Tailwind, Bootstrap, CoreUI, CSS Modules, styled-components, React, Vite, Gatsby, WordPress, Drupal, PHP, MySQL, Docker, and Figma (and used more project tracking and business apps than I can count). I'm good at professional communication, solving complex problems, and keeping track of multiple competing tasks.
</Details>
...
<LessProfessional>
I live in Virginia, US, with a spouse, kid, and two cats, and:
